...
const NavbarLeft = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full h-[100px] bg-purple-600 shadow-md z-10 transition-width duration-500">
        <div className="flex justify-between items-center h-full p-4">
          ...
          <div className="flex flex-col gap-4 items-stretch p-4">
            <ul className="flex flex-col">
              <li className="my-2 uppercase hover:border-b text-sm -rotate-90 font-chakra text-white">
